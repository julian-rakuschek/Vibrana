            ...
            >
                <form on:submit|preventDefault={save}>
                    <div class="bg-white rounded-lg p-4 flex flex-col items-center gap-4">
                        ...
                        <input bind:value={machine_name} placeholder="Machine Name"
                               class="block w-full rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
