...
<div class="w-full">
    ...
    <br/>
    <p>The Vibrana tool offers the following features:</p>
    ...
    <br/>
    <br/>
    <p class="text-2xl font-semibold">How to analyze data with Vibrana</p>
    <br/>
    <p>
    ...
    <br/>
    <div class="bg-indigo-50 text-indigo-500 rounded-lg p-3"><b>Hint:</b>
    ...
    <br/>
    <StyledDisclosure header_text="Video: Inspecting the time series paths.">
    ...
    <p>
        ...
        That is, the saved anomaly is slided across all signals and in each timestep, the similarity is computed using
        the euclidean distance.
        Therefore, a high similarity of the signal to the label or a low distance from the euclidean distance (beware of
        the duality) indicates that the pattern occurred again.
    </p>
    <br/>
    <p>
    ...
    <StyledDisclosure header_text="Video: Selecting Normals">
        <div class="w-full flex justify-center">
            <video src="/intro/videos/normal-selection.mp4" autoplay loop muted></video>
        </div>
    </StyledDisclosure>
    <br/>
    <p>
        The computed distances can be further inspected by choosing a signal and changing the color mode accordingly.
        This process of selecting labels, selecting normals and computing distances can be repeated until a satisfactory
        result is achieved.
    </p>
    <br/>
    <div class="bg-red-100 text-red-500 rounded-lg p-3"><b>Note:</b>
