...
def test_plot():
    ...
    normal = requests.get("http://localhost:5000/api/analysis/5-10-1t-10-16/normal-0004/similarities").json()
...
def something():
    normal = requests.get("http://localhost:5000/api/analysis/5-10-1t-10-16/normal-0008/similarities").json()
