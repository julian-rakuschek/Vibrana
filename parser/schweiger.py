...
data_folder = os.path.join(Path(__file__).parents[1], "data", "raw", "schweiger")
parsed_folder = os.path.join(Path(__file__).parents[1], "data", "parsed", "schweiger")
...
def parse_folder(
    ...
    for file in os.listdir(folder_path):
        ...
        split_and_process_time_series(values, timestamps, events, file, prefix, "schweiger", folder, max_sample_size, window_size, None, limit=7)


if __name__ == '__main__':
    parse_folder("bearing")
