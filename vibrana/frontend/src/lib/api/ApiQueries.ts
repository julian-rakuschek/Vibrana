...
function getQueryParams<TRequestData, TRequestParams, TQueryParams, TResponse extends AppResponse<any>>(requestObj: MultiRequestPart<TRequestData, TRequestParams, TQueryParams, TResponse>): CreateQueryOptions<TResponse> {
...
export function useQueryFetch<TRequestData, TRequestParams, TQueryParams, TResponse>(
    ...
    const queryParams = getQueryParams<TRequestData, TRequestParams, TQueryParams, TResponse>({apiRoute, requestObject});
